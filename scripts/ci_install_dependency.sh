...
pip install git+https://github.com/huggingface/transformers.git@v4.51.3-Qwen2.5-Omni-preview sentence_transformers accelerate peft pandas datasets timm torchaudio==2.6.0
