(function attachRealtimePlaybackController(global) {
  const DEFAULT_CONFIG = {
    ...
    deliveryFpsAlphaDown: 0.22,
    targetLeadChunkRatio: 2.0,
    minTargetLeadMs: 1900,
    maxTargetLeadMs: 3600,
    maxLeadExtraChunkRatio: 12.0,
    startLeadChunkRatio: 2.25,
    minStartLeadMs: 2000,
    resumeLeadChunkRatio: 2.0,
    minResumeLeadMs: 1400,
    maxResumeLeadMs: 2600,
    rebufferLeadBoostMs: 350,
    rebufferLeadBoostDecayMsPerSecond: 80,
    deliveryLeadBoostDecayMsPerSecond: 45,
    maxDeliveryLeadBoostMs: 2600,
    deliveryStallExpectedMultiplier: 1.25,
    startupMaxHoldMs: 900,
    receiveStallPlaybackRateMin: 0.8,
    receiveStallPlaybackRateSlewPerSecond: 0.5,
    lowWaterRatio: 0.55,
    playbackRateGain: 0.08,
    playbackRateMin: 0.95,
    playbackRateMax: 1.05,
    emergencyPlaybackRateMin: 0.88,
    emergencyPlaybackRateMax: 1.08,
    playbackRateSlewPerSecond: 0.05,
    eventCutoverMaxMs: 1400,
    eventCutoverMaxFrames: 36,
    settleEventCutoverMaxMs: 1900,
    settleEventCutoverMaxFrames: 48,
  ...
  class RealtimePlaybackController {
    ...
    #eventGraceFrames() {
      ...
      const byChunkRatio = this.pendingEventCutoverMode === "settle" ? 2.8 : 2.25;
