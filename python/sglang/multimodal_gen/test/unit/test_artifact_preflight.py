...
def _server_args(**overrides):
    values = {
        ...
        "component_weights_paths": {"transformer": "/weights/dit.safetensors"},
...
def test_preflight_json_report_is_machine_readable(capsys):
    server_args = _server_args(artifact_report_format="json")
    with patch(
    ...
    assert '"resolved_revision": "sha"' in output
