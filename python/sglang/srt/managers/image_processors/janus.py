...
def load_pil_images(conversations: List[Dict[str, str]]) -> List[Image]:
    ...
    Returns:
        pil_images (List[Image]): the list of PIL images.
...
from sglang.srt.managers import image_processor


class JanusProProcessor(image_processor.BaseImageProcessor):
    ...
    async def process_images_async(
        ...
        return {
            ...
            "image_token_id": res["image_token_id"],
        }


EntryClass = {"MultiModalityCausalLM": JanusProProcessor}
