...
_IMAGE_PROCESSOR_REGISTRY: Dict[str, Type[BaseImageProcessor]] = {
    Qwen2_5_VLConfig.model_type: Qwen2_5_VLImageProcessor,
}

_IMAGE_PROCESSOR_REGISTRY: Dict[str, Type[PretrainedConfig]] = {
    ChatGLMConfig.model_type: ChatGLMConfig,
}
...
for config_cls, cls in _IMAGE_PROCESSOR_REGISTRY.items():
    with contextlib.suppress(ValueError):
        AutoImageProcessor.register(config_cls, None, cls, None, exist_ok=True)
